...
.navbar .navbar-search .search-query:focus {
    ...
    <!-- html5 -->
    <!--[if lt IE 9]>
	<!--<script src="${ctx}/s/lemon/respond/1.4.2/respond.min.js"></script>-->
    <!--<script type="text/javascript" src="${ctx}/s/lemon/html5/html5shiv.js"></script>-->
    <![endif]-->
	...
	<!-- bootstrap -->
    <script type='text/javascript' src='${ctx}/s/bootstrap/3.3.6/js/bootstrap.min.js'></script>

    <!-- message -->
    <script type="text/javascript" src="${ctx}/s/media/js/jquery.slidingmessage.min.js"></script>
    <script type="text/javascript" src="${ctx}/s/app/mossle/table.js"></script>
    ...
    <!-- datepicker -->
    <link type="text/css" rel="stylesheet" href="${ctx}/s/bootstrap/bootstrap-datepicker/datepicker.css">
    <script type="text/javascript" src="${ctx}/s/bootstrap/bootstrap-datepicker/bootstrap-datepicker.js"></script>
    <script type="text/javascript" src="${ctx}/s/bootstrap/bootstrap-datepicker/locales/bootstrap-datepicker.${locale}.js"></script>
    <link href="${ctx}/s/bootstrap/bootstrap-datetimepicker/css/datetimepicker.css" rel="stylesheet">
    <script type="text/javascript" src="${ctx}/s/bootstrap/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"></script>
    <script type="text/javascript" src="${ctx}/s/bootstrap/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.${locale}.js"></script>
	...
	<!-- tablednd -->
    <script type="text/javascript" src="${ctx}/s/media/js/jquery.tablednd.min.js"></script>
