                ...
                <div class="span12">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="clearfix">
                            ...
                            <td style="border: none">
                                ...
                                <select class="span2 chosen" data-with-diselect="1" data-placeholder="请选择区域" tabindex="1" name="region" id="region_search_company_month"
                                        onchange="EvaluationInfoList.getPartyEntitiesByRegionAndDepartment_company($('#partyEntity_search_company_month'))">
                            ...
                            <td style="border: none">
                                ...
                                <select class="span2 chosen" data-with-diselect="1" data-placeholder="请选择专业公司" tabindex="1" name="partyEntity" id="department_search_company_month"
                                        onchange="EvaluationInfoList.getPartyEntitiesByRegionAndDepartment_company($('#region_search_company_month'),$('#department_search_company_month'),$('#partyEntity_search_company_month'))">
                            ...
                            <td style="border: none">
                                ...
                                <select class="span2 chosen" data-with-diselect="1" data-placeholder="请选择查询对象" tabindex="1" name="partyEntity" id="partyEntity_search_company_month"
                                        onchange="EvaluationInfoList.setPartyEntities($('#partyEntity_search_company_month'))">
                            ...
                            <td>
                                ...
                                <div class="m-wrap input-append date form_date" data-date-format="yyyy-MM" data-date-viewmode="years">
                                    <input id="txt_company_month_begin" class="m-wrap m-ctrl-medium" style="width: 170px" readonly size="16" type="text" value="" />
                                </div>
                                ~
                                <div  class="m-wrap input-append date form_date" data-date-format="yyyy-MM" data-date-viewmode="years">
                                    <input id="txt_company_month_end" class="m-wrap m-ctrl-medium" style="width: 170px" readonly size="16" type="text" value="" />
                                </div>
                            ...
                            <div class="btn-group">
                                ...
                                <button id="btnSearch_company_month" class="btn blue">
                    ...
                    <div class="portlet box purple">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption"><i class="icon-edit"></i>专业公司人员月度考核列表</div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="table_evaluation_company_month">
...
<script>
    ...
    $(function() {
        ...
        EvaluationInfoList.init_company_month();
