                    ...
                    <div class="portlet-body">
                        ...
                        <div class="clearfix">
                            ...
                            <td style="border: none">
                                ...
                                <select class="span2 chosen" data-with-diselect="1" data-placeholder="请选择区域" tabindex="1" name="region" id="region_search_patrol_quarter"
                                        onchange="EvaluationInfoList.getPartyEntitiesByRegionAndDepartment(this.value,'巡查部门',$('#partyEntity_search_patrol_quarter'))">
                            ...
                            <td style="border: none">
                                ...
                                <select class="span2 chosen" data-with-diselect="1" data-placeholder="请选择查询对象" tabindex="1" name="partyEntity" id="partyEntity_search_patrol_quarter"
                                        onchange="EvaluationInfoList.setPartyEntities($('#partyEntity_search_patrol_quarter'))">
                            ...
                            <td>
                                ...
                                <div class="m-wrap input-append date form_date" data-date-format="yyyy" data-date-viewmode="years">
                                    <input id="txt_patrol_quarter" class="m-wrap m-ctrl-medium" readonly size="16" type="text" value="" />
                                </div>
                            ...
                            <div class="btn-group">
                                ...
                                <button id="btnSearch_patrol_quarter" class="btn blue">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="table_evaluation_patrol_quarter">
...
<script>
    ...
    $(function() {
        ...
        EvaluationInfoList.init_patrol_quarter();
