...
<%pageContext.setAttribute("thirdMenu", "quarterEvaluate");%>
...
<input id="quarter_text" type="hidden" value="季度考核">
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <%@include file="/common/layout/second-menu-evaluate-quarter.jsp"%>
                ...
                <div class="span12">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="clearfix">
                            ...
                            <td style="border: none">
                                ...
                                <select class="span2 chosen" data-with-diselect="1" data-placeholder="请选择区域" tabindex="1" name="region" id="region_search_company_quarter"
                                        onchange="EvaluationInfoList.getPartyEntitiesByRegionAndDepartment_company($('#region_search_company_quarter'),$('#department_search_company_quarter'),$('#partyEntity_search_company_quarter'))">
                            ...
                            <td style="border: none">
                                ...
                                <select class="span2 chosen" data-with-diselect="1" data-placeholder="请选择专业公司" tabindex="1" name="partyEntity" id="department_search_company_quarter"
                                        onchange="EvaluationInfoList.getPartyEntitiesByRegionAndDepartment_company($('#region_search_company_quarter'),$('#department_search_company_quarter'),$('#partyEntity_search_company_quarter'))">
                            ...
                            <td style="border: none">
                                ...
                                <select class="span2 chosen" data-with-diselect="1" data-placeholder="请选择查询对象" tabindex="1" name="partyEntity" id="partyEntity_search_company_quarter"
                                        onchange="EvaluationInfoList.setPartyEntities($('#partyEntity_search_company_quarter'))">
                            ...
                            <td>
                                ...
                                <div class="m-wrap input-append date form_date" data-date-format="yyyy" data-date-viewmode="years">
                                    <input id="txt_company_quarter" class="m-wrap m-ctrl-medium" readonly size="16" type="text" value="" />
                                </div>
                            ...
                            <div class="btn-group">
                                ...
                                <button id="btnSearch_company_quarter" class="btn blue">
                    ...
                    <div class="portlet box yellow">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption"><i class="icon-edit"></i>专业公司人员季度考核列表</div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="table_evaluation_company_quarter">
...
<script>
    ...
    $(function() {
        ...
        EvaluationInfoList.init_company_quarter();
