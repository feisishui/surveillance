                ...
                <article class="m-widget">
                    ...
                    <div class="content content-inner">
                        ...
                        <form id="orgForm" method="post"
                              action="admin-batch-save.do?id=${id}&groupTypeId=${groupTypeId}" class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <table class="table table-striped table-bordered table-hover" style="width:auto;">
                                        <thead>
                                        <tr>
                                            <th width="10" style="text-indent:0px;text-align:center;"><input
                                                    type="checkbox" name="checkAll"
                                                    onchange="toggleSelectedItems(this.checked)"></th>
                                            <th class="sorting" name="id"><spring:message code="user.user.list.id"
                                                                                          text="编号"/></th>
                                        ...
                                        <c:forEach items="${userDtos}" var="item">
                                            <tr>
                                                <td><input type="checkbox" class="selectedItem" name="userIds"
                                                           value="${item.id}"></td>
                                                <td>${id}</td>
                                                <td>${username}</td>
