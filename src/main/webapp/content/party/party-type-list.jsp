                ...
                <section id="m-main"  style="padding-top:25px;margin-right: 30px">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right ctrl">
                                <a class="btn btn-default btn-xs"><i id="party-typeSearchIcon"
                        ...
                        <div class="panel-body">
                            ...
                            <form name="party-typeForm" method="post" action="party-type-list.do" class="form-inline">
                                <label for="party-type_name"><spring:message
                                        code='party-type.party-type.list.search.name' text='名称'/>:</label>
                                <input type="text" id="party-type_name" name="filter_LIKES_name"
                                       value="${param.filter_LIKES_name}" class="form-control">
                                <button class="btn btn-default a-search" onclick="document.party-typeForm.submit()">查询
                                </button>
                                &nbsp;
                            </form>
                    ...
                    <div style="margin-bottom: 20px;">
                        <div class="pull-left btn-group" role="group">
                            <button class="btn btn-default a-insert" onclick="location.href='party-type-input.do'">新建
                            </button>
                    ...
                    <form id="party-typeGridForm" name="party-typeGridForm" method='post' action="party-type-remove.do"
                          class="m-form-blank">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="glyphicon glyphicon-list"></i>
                            ...
                            <table id="orgTypeGrid" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting" name="id"><spring:message code="org.type.list.id"
                                                                                  text="编号"/></th>
                                    <th class="sorting" name="name"><spring:message code="org.type.list.name"
                                                                                    text="名称"/></th>
                                ...
                                <c:forEach items="${page.result}" var="item" varStatus="idxStatus">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="party-type-input.do?id=${item.id}"><spring:message
