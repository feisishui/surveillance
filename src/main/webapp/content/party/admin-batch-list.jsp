                ...
                <section id="m-main" style="padding-top:65px;;margin-right: 30px">
                    ...
                    <article class="m-widget">
                        ...
                        <div class="content content-inner">
                            ...
                            <form id="orgForm" method="post"
                                  action="admin-batch-input.do?id=${id}&groupTypeId=${groupTypeId}"
                    ...
                    <article class="m-widget">
                        ...
                        <div class="content">
                            ...
                            <form id="userGridForm" name="orgEntityGridForm" method='post'
                                  action="admin-batch-remove.do?id=${id}&groupTypeId=${groupTypeId}"
                                  class="m-form-blank">
