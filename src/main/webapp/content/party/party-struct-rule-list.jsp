        ...
        <div class="row-fluid" class="col-md-10" style="margin-left: 10px;">
            ...
            <div class="span12">
                ...
                <section id="m-main"  style="padding-top:25px;margin-right: 30px">
                    ...
                    <div style="margin-bottom: 20px;">
                        <div class="pull-left btn-group" role="group">
                            <button class="btn btn-default a-insert"
                                    onclick="location.href='party-struct-rule-input.do'">新建
                            </button>
                    ...
                    <form id="party-struct-ruleGridForm" name="party-struct-ruleGridForm" method='post'
                          action="party-struct-rule-remove.do" class="m-form-blank">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="glyphicon glyphicon-list"></i>
                            ...
                            <table id="orgStructRuleGrid" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting" name="partyStructType.id"><spring:message
                                            code="org.structrule.list.type" text="结构类型"/></th>
                                    <th class="sorting" name="parentType.id"><spring:message
                                            code="org.structrule.list.parentype" text="上级类型"/></th>
                                    <th class="sorting" name="childType.id"><spring:message
                                            code="org.structrule.list.childtype" text="下级类型"/></th>
                                    <th width="50">&nbsp;</th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach items="${page.result}" var="item" varStatus="idxStatus">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="party-struct-rule-input.do?id=${item.id}"><spring:message
