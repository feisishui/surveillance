                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="orgForm" method="post" action="org-save.do" class="form-horizontal">
                                <input id="org_partyStructTypeId" type="hidden" name="partyStructTypeId"
                                       value="${partyStructTypeId}">
                                <input id="org_partyEntityId" type="hidden" name="partyEntityId"
                                       value="${partyEntityId}">
                                ...
                                <c:if test="${partyType.type == 1}">
                                    <div class="form-group">
                                        <label class="control-label col-md-1" for="org_orgname"><spring:message
                                                code="org.org.input.orgname" text="名称"/></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <label for="orgInputUser_status1" class="radio inline">
                                                <input id="orgInputUser_status1" type="radio" name="status" value="1"
                                                       class="required" checked>
                                                主职
                                            </label>
                                            <label for="orgInputUser_status2" class="radio inline">
                                                <input id="orgInputUser_status2" type="radio" name="status" value="2"
                                                       class="required">
                                                兼职
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input id="orgInputUser_priority" type="text" name="priority" value=""
                                                   size="40" class="form-control required number" minlength="1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <label for="orgInputUser_admin0" class="radio inline">
                                                <input id="orgInputUser_admin0" type="radio" name="admin" value="0"
                                                       class="required" checked>
                                                员工
                                            </label>
                                            <label for="orgInputUser_admin1" class="radio inline">
                                                <input id="orgInputUser_admin1" type="radio" name="admin" value="1"
                                                       class="required">
                                                负责人
                                            </label>
                                            <label for="orgInputUser_status2" class="validate-error" generated="true"
                                ...
                                <c:if test="${partyType.type == 2}">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-1" for="org_name"><spring:message
                                                code="org.org.input.orgname" text="名称"/></label>

                                        <div class="col-sm-5">
                                            <input id="org_id" type="hidden" name="childEntityId" value="">
                                            <input id="org_name" type="text" name="childEntityName" value="" size="40"
                                                   class="form-control required" minlength="1" maxlength="50"
                                                   autocomplete="off">
                                            <button id="btnClean" type="button" class="btn" style="display:none;">清空
                                            </button>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-1 col-sm-5">
                                        ...
                                        <button type="button" onclick="history.back();" class="btn btn-link">
