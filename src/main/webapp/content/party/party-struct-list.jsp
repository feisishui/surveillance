                ...
                <section id="m-main"  style="padding-top:25px;margin-right: 30px">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right ctrl">
                                <a class="btn btn-default btn-xs"><i id="party-structSearchIcon"
                                                                     class="glyphicon glyphicon-chevron-up"></i></a>
                            </div>
                        </div>
                        <div class="panel-body">

                            <form name="party-structForm" method="post" action="party-struct-list.do"
                                  class="form-inline">
                                <label for="party-struct_name"><spring:message
                                        code='party-struct.party-struct.list.search.name' text='名称'/>:</label>
                                ...
                                <button class="btn btn-default a-search" onclick="document.party-structForm.submit()">
                                    查询
                                </button>
                                &nbsp;
                            </form>
                    ...
                    <div style="margin-bottom: 20px;">
                        <div class="pull-left btn-group" role="group">
                            <button class="btn btn-default a-insert" onclick="location.href='party-struct-input.do'">
                                新建
                            </button>
                    ...
                    <form id="party-structGridForm" name="party-structGridForm" method='post'
                          action="party-struct-remove.do" class="m-form-blank">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="glyphicon glyphicon-list"></i>
                            ...
                            <table id="orgStructGrid" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting" name="partyStructType.id"><spring:message
                                            code="org.struct.list.type" text="类型"/></th>
                                    <th class="sorting" name="parentEntity.id"><spring:message
                                            code="org.struct.list.parententity" text="上级组织"/></th>
                                    <th class="sorting" name="childEntity.id"><spring:message
                                            code="org.struct.list.childentity" text="下级组织"/></th>
                                    <th class="sorting" hidden="hidden"  name="partTime">兼职</th>
                                    <th class="sorting" hidden="hidden"  name="link">关联</th>
                                    <th class="sorting" hidden="hidden"  name="priority">排序</th>
                                    <th class="sorting" hidden="hidden"  name="admin">管理</th>
                                    <th width="20">&nbsp;</th>
                                </tr>
                                </thead>
                                <tbody>
                                <c:forEach items="${page.result}" var="item" varStatus="idxStatus">
                                    <tr>
                                        ...
                                        <td>${item.admin}</td>
                                        <td>
                                            <a href="party-struct-input.do?id=${item.id}"><spring:message
