        ...
        <div class="row-fluid" class="col-md-10" style="margin-left: 10px;">
            ...
            <div class="span12">
                ...
                <section id="m-main"  style="padding-top:25px;margin-right: 30px">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right ctrl">
                                <a class="btn btn-default btn-xs"><i id="party-struct-typeSearchIcon"
                                                                     class="glyphicon glyphicon-chevron-up"></i></a>
                            </div>
                        </div>
                        <div class="panel-body">

                            <form name="party-struct-typeForm" method="post" action="party-struct-type-list.do"
                                  class="form-inline">
                                <label for="party-struct-type_name"><spring:message
                                        code='party-struct-type.party-struct-type.list.search.name' text='名称'/>:</label>
                                <input type="text" id="party-struct-type_name" name="filter_LIKES_name"
                                       value="${param.filter_LIKES_name}" class="form-control">
                                <button class="btn btn-default a-search"
                                        onclick="document.party-struct-typeForm.submit()">查询
                                </button>
                                &nbsp;
                            </form>
                    ...
                    <div style="margin-bottom: 20px;">
                        <div class="pull-left btn-group" role="group">
                            <button class="btn btn-default a-insert"
                                    onclick="location.href='party-struct-type-input.do'">新建
                            </button>
                    ...
                    <form id="party-struct-typeGridForm" name="party-struct-typeGridForm" method='post'
                          action="party-struct-type-remove.do" class="m-form-blank">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="glyphicon glyphicon-list"></i>
                            ...
                            <table id="orgStructTypeGrid" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting" name="id"><spring:message code="org.structtype.list.id"
                                                                                  text="编号"/></th>
                                    <th class="sorting" name="name"><spring:message code="org.structtype.list.name"
                                                                                    text="名称"/></th>
                                ...
                                <c:forEach items="${page.result}" var="item" varStatus="idxStatus">
                                    <tr>
                                        ...
                                        <td>${item.ref}</td>
                                        <td>
                                            <a href="party-struct-type-input.do?id=${item.id}"><spring:message
