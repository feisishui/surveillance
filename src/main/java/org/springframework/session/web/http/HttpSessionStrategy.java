...
public interface HttpSessionStrategy {
	 ...
	 * {@link HttpServletRequest}. For example, the session id might
	 ...
	 * @return the {@link HttpServletRequest} to obtain the session id
	 * from.
	 */
	 ...
	 * @param request the {@link HttpServletRequest} that create the
	 * new {@link org.springframework.session.Session} Cannot be null.
	 * @param response the {@link HttpServletResponse} that is
	 * associated with the {@link HttpServletRequest} that created the
	 * new {@link org.springframework.session.Session} Cannot be null.
	 */
	 ...
	 *
	 * @param request the {@link HttpServletRequest} that invalidated
	 * the {@link org.springframework.session.Session} Cannot be null.
	 * @param response the {@link HttpServletResponse} that is
	 * associated with the {@link HttpServletRequest} that invalidated
	 * the {@link org.springframework.session.Session} Cannot be null.
	 */
