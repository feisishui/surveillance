package com.casic.patrol.party.service;
...
public class PartyService {
    ...
    //By Fan
    public PartyEntity getChiildEntityByNames(String parentName,String childName) {
        String hql = "select ps.childEntity from PartyStruct ps where ps.parentEntity.name=? and ps.childEntity.name=?";
        return partyEntityManager.findUnique(hql, parentName, childName);
    }

    public PartyEntity getEntityByNames(String name) {
        String hql = "from PartyEntity where name=?";
        return partyEntityManager.findUnique(hql, name);
    }
