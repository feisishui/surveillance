 ...
 */
@Entity
@Table(name="CD_PARTY_STRUCT")
@SequenceGenerator(name = "CD_PARTY_STRUCTIS",sequenceName = "CD_PARTY_STRUCTIS",allocationSize = 1,initialValue = 1)
public class PartyStruct implements java.io.Serializable {
    ...
    /** @return 主键. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_PARTY_STRUCTIS")
    public Long getId() {
        return this.id;
    }
