 ...
 */
@Entity
@Table(name="CD_PARTY_STRUCT_RULE")
@SequenceGenerator(name = "CD_PARTY_STRUCT_RULEIS",sequenceName = "CD_PARTY_STRUCT_RULEIS",allocationSize = 1,initialValue = 1)
public class PartyStructRule implements java.io.Serializable {
    ...
    /** @return 主键. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_PARTY_STRUCT_RULEIS")
    public Long getId() {
        return this.id;
    }
