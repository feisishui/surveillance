 ...
 */
@Entity
@Table(name="CD_PARTY_STRUCT_TYPE")
@SequenceGenerator(name = "CD_PARTY_STRUCT_TYPEIS",sequenceName = "CD_PARTY_STRUCT_TYPEIS",allocationSize = 1,initialValue = 1)
public class PartyStructType implements java.io.Serializable {
    ...
    /** @return 主键. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_PARTY_STRUCT_TYPEIS")
    public Long getId() {
        return this.id;
    }
