...
@SequenceGenerator(name = "CD_SEQ_MODEL_FIELD",sequenceName = "CD_SEQ_MODEL_FIELD",allocationSize = 1,initialValue = 1)
...
public class ModelField implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_MODEL_FIELD")
