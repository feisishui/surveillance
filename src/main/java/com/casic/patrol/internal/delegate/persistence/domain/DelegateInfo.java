...
@SequenceGenerator(name = "CD_SEQ_DELEGATE_INFO",sequenceName = "CD_SEQ_DELEGATE_INFO",allocationSize = 1,initialValue = 1)
public class DelegateInfo implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_DELEGATE_INFO")
    public Long getId() {
        return this.id;
    }
