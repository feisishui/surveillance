...
@SequenceGenerator(name = "CD_SEQ_TEMPLATE_INFO",sequenceName = "CD_SEQ_TEMPLATE_INFO",allocationSize = 1,initialValue = 1)
public class TemplateInfo implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TEMPLATE_INFO")
    public Long getId() {
        return this.id;
    }
