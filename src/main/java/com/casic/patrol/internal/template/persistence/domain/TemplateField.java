package com.casic.patrol.internal.template.persistence.domain;
...
@SequenceGenerator(name = "CD_SEQ_TEMPLATE_FIELD",sequenceName = "CD_SEQ_TEMPLATE_FIELD",allocationSize = 1,initialValue = 1)
public class TemplateField implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TEMPLATE_FIELD")
    public Long getId() {
        return this.id;
    }
