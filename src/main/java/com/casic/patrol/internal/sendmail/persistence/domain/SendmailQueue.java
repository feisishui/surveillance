...
@SequenceGenerator(name = "CD_SEQ_SENDMAIL_QUEUE",sequenceName = "CD_SEQ_SENDMAIL_QUEUE",allocationSize = 1,initialValue = 1)
...
public class SendmailQueue implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_SENDMAIL_QUEUE")
    public Long getId() {
        return this.id;
    }
