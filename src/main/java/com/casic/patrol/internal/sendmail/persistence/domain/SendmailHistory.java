...
@SequenceGenerator(name = "CD_SEQ_SENDMAIL_HISTORY",sequenceName = "CD_SEQ_SENDMAIL_HISTORY",allocationSize = 1,initialValue = 1)
public class SendmailHistory implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_SENDMAIL_HISTORY")
    public Long getId() {
        return this.id;
    }
