...
@SequenceGenerator(name = "CD_SEQ_SENDMAIL_TEMPLATE",sequenceName = "CD_SEQ_SENDMAIL_TEMPLATE",allocationSize = 1,initialValue = 1)
...
public class SendmailTemplate implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_SENDMAIL_TEMPLATE")
    public Long getId() {
        return this.id;
    }
