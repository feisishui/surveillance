...
@SequenceGenerator(name = "CD_SEQ_SENDMAIL_CONFIG",sequenceName = "CD_SEQ_SENDMAIL_CONFIG",allocationSize = 1,initialValue = 1)
...
public class SendmailConfig implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_SENDMAIL_CONFIG")
    public Long getId() {
        return this.id;
    }
    ...
    /** @return null. */
    @Column(name = "CONFIG_USERNAME", length = 200)
    ...
    /** @return null. */
    @Column(name = "CONFIG_PASSWORD", length = 200)
