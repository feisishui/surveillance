...
@SequenceGenerator(name = "CD_SEQ_WORKCAL_PART",sequenceName = "CD_SEQ_WORKCAL_PART",allocationSize = 1,initialValue = 1)
public class WorkcalPart implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_WORKCAL_PART")
    public Long getId() {
        return this.id;
    }
