package com.casic.patrol.api.process;
...
public class MockProcessConnector implements ProcessConnector {
    ...
    @Override
    public Page findRunningProcessInstances(String tenantId, Page page) {
        return null;
    }

    @Override
    public List<HistoricProcessInstance> findAllRunningProcessInstances(String tenantId) {
        return null;
    }
