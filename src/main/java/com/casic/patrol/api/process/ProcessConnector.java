...
public interface ProcessConnector {
     ...
     * 未结流程.
     */
    Page findRunningProcessInstances(String tenantId, Page page);

    /**
     * 未结流程.
     */
    List<HistoricProcessInstance> findAllRunningProcessInstances(String tenantId);
     ...
     * 流程实例.
     */
    Page findProcessInstances(String tenantId);
