...
public interface HumanTaskConnector {
    ...
    Page findPersonalTasksByName(String userId, String tenantId, int pageNo,
                                        int pageSize,String taskName);

    List<HumanTaskDTO> findPersonalTasks(String userId, String tenantId, String lastId);

    String getTaskNumber(String userId, String tenantId);

    List<HumanTaskDTO> findFinishedPersonalTasks(String userId, String tenantId, String lastId);
