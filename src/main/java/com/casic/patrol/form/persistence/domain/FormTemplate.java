package com.casic.patrol.form.persistence.domain;
...
@SequenceGenerator(name = "CD_SEQ_FORM_TEMPLATE",sequenceName = "CD_SEQ_FORM_TEMPLATE",allocationSize = 1,initialValue = 1)
public class FormTemplate implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_FORM_TEMPLATE")
    public Long getId() {
        return this.id;
    }
