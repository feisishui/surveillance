...
@SequenceGenerator(name = "CD_SEQ_FORM_SCHEMA",sequenceName = "CD_SEQ_FORM_SCHEMA",allocationSize = 1,initialValue = 1)
public class FormSchema implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_FORM_SCHEMA")
    public Long getId() {
        return this.id;
    }
