...
@Entity
@Table(name = "TASK_LOG")
@SequenceGenerator(name = "CD_SEQ_TASKLOG",sequenceName = "CD_SEQ_TASKLOG",allocationSize = 1,initialValue = 1)
public class TaskLog implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKLOG")
