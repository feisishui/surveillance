...
@SequenceGenerator(name = "CD_SEQ_TASKDEFDEADLINE",sequenceName = "CD_SEQ_TASKDEFDEADLINE",allocationSize = 1,initialValue = 1)
public class TaskDefDeadline implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKDEFDEADLINE")
    public Long getId() {
        return this.id;
    }
