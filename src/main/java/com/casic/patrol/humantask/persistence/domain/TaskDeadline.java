...
@SequenceGenerator(name = "CD_SEQ_TASKDEADLINE",sequenceName = "CD_SEQ_TASKDEADLINE",allocationSize = 1,initialValue = 1)
public class TaskDeadline implements java.io.Serializable {
    ...
    /** @return 主键. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKDEADLINE")
