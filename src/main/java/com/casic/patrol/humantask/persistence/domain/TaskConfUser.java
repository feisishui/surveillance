...
@SequenceGenerator(name = "CD_SEQ_TASKCONFUSER",sequenceName = "CD_SEQ_TASKCONFUSER",allocationSize = 1,initialValue = 1)
public class TaskConfUser implements java.io.Serializable {
    ...
    /** @return 主键. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKCONFUSER")
