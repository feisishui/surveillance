...
@SequenceGenerator(name = "CD_SEQ_TASKDEFUSER",sequenceName = "CD_SEQ_TASKDEFUSER",allocationSize = 1,initialValue = 1)
...
public class TaskDefUser implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKDEFUSER")
    public Long getId() {
        return this.id;
    }
