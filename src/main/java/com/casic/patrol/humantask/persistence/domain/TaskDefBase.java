...
@SequenceGenerator(name = "CD_SEQ_TASKDEFBASE",sequenceName = "CD_SEQ_TASKDEFBASE",allocationSize = 1,initialValue = 1)
public class TaskDefBase implements java.io.Serializable {
    ...
    /** @return 主键. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKDEFBASE")
