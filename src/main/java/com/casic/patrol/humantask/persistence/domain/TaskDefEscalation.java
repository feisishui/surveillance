...
@SequenceGenerator(name = "CD_SEQ_TASKDEFESCALATION",sequenceName = "CD_SEQ_TASKDEFESCALATION",allocationSize = 1,initialValue = 1)
public class TaskDefEscalation implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKDEFESCALATION")
    public Long getId() {
        return this.id;
    }
