...
@SequenceGenerator(name = "CD_SEQ_HTHUMANTASK",sequenceName = "CD_SEQ_HTHUMANTASK",allocationSize = 1,initialValue = 1)
public class HtHumantask implements java.io.Serializable {
    ...
    /** @return 主键. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_HTHUMANTASK")
