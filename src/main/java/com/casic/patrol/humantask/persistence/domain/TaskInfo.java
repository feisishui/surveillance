...
@SequenceGenerator(name = "CD_SEQ_TASKINFO",sequenceName = "CD_SEQ_TASKINFO",allocationSize = 1,initialValue = 1)
public class TaskInfo implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKINFO")
    public Long getId() {
        return this.id;
    }
