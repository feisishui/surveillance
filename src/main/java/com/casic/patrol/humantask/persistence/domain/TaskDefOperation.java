...
@SequenceGenerator(name = "CD_SEQ_TASKDEFOPERATION",sequenceName = "CD_SEQ_TASKDEFOPERATION",allocationSize = 1,initialValue = 1)
public class TaskDefOperation implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKDEFOPERATION")
    public Long getId() {
        return this.id;
    }
