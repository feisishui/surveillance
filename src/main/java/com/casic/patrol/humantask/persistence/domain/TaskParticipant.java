...
@SequenceGenerator(name = "CD_SEQ_TASKPARTICIPANT",sequenceName = "CD_SEQ_TASKPARTICIPANT",allocationSize = 1,initialValue = 1)
...
public class TaskParticipant implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_TASKPARTICIPANT")
    public Long getId() {
        return this.id;
    }
