...
public class TaskOperationController {
    ...
    public String viewTaskForm(@RequestParam("humanTaskId") String humanTaskId,
        ...
        logManager.saveLogRelatedWithTask("查看任务表单", StringUtils.LOG_TASK_RELATED, humanTaskId);
...
//            buttons.add(buttonHelper.findButton("saveDraft"));
    ...
    public String completeTask(HttpServletRequest request,
        ...
        String userId = session.getAttribute(StringUtils.USERID).toString();
...
//            return "redirect:/portal/index.do";
        ...
        logManager.saveLogBaseOnTask(humanTaskId);
    ...
    public String claimTask(@RequestParam("humanTaskId") String humanTaskId) {
        ...
        logManager.saveLogRelatedWithTask("领取任务", StringUtils.LOG_TASK_RELATED, humanTaskId);
