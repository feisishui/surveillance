package com.casic.patrol.msg.persistence.domain;
...
@Entity
@Table(name = "MSG_INFO")
@SequenceGenerator(name = "CD_SEQ_MSG_INFO",sequenceName = "CD_SEQ_MSG_INFO",allocationSize = 1,initialValue = 1)
public class MsgInfo implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_MSG_INFO")
    public Long getId() {
        return this.id;
    }
