package com.casic.patrol.todoTask.dto;
...
public class ToDoTaskDTO {
    ...
    private Integer emergencyLevelNum;
    ...
    private OvertimeLevel overtimeLevel;
    private Integer overtimeLevelNum;
    private Date startTime;
    private List<ToDoTaskDTO> children = new ArrayList<ToDoTaskDTO>();
    ...
    public List<ToDoTaskDTO> getChildren() {
        return children;
    }

    public void setChildren(List<ToDoTaskDTO> children) {
    ...
    public OvertimeLevel getOvertimeLevel() {
        return overtimeLevel;
    }

    public void setOvertimeLevel(OvertimeLevel overtimeLevel) {
    ...
    public Integer getEmergencyLevelNum() {
        return emergencyLevelNum;
    }

    public void setEmergencyLevelNum(Integer emergencyLevelNum) {
        this.emergencyLevelNum = emergencyLevelNum;
    }

    public Integer getOvertimeLevelNum() {
        return overtimeLevelNum;
    }

    public void setOvertimeLevelNum(Integer overtimeLevelNum) {
        this.overtimeLevelNum = overtimeLevelNum;
    }
}
