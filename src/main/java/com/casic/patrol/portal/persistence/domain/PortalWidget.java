...
@SequenceGenerator(name = "CD_SEQ_PORTAL_WIDGET",sequenceName = "CD_SEQ_PORTAL_WIDGET",allocationSize = 1,initialValue = 1)
public class PortalWidget implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_PORTAL_WIDGET")
    public Long getId() {
        return this.id;
    }
    ...
    /** @return null. */
    @Column(name = "WIDGET_URL", length = 200)
    ...
    /** @return null. */
    @Column(name = "WIDGET_DATA", length = 200)
