...
@SequenceGenerator(name = "CD_SEQ_PORTAL_INFO",sequenceName = "CD_SEQ_PORTAL_INFO",allocationSize = 1,initialValue = 1)
...
public class PortalInfo implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_PORTAL_INFO")
    public Long getId() {
        return this.id;
    }
    ...
    /** @return null. */
    @Column(name = "INFO_NAME", length = 200)
