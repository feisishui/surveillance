...
@SequenceGenerator(name = "CD_SEQ_PORTAL_ITEM",sequenceName = "CD_SEQ_PORTAL_ITEM",allocationSize = 1,initialValue = 1)
...
public class PortalItem implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_PORTAL_ITEM")
    ...
    /** @return null. */
    @Column(name = "ITEM_DATA", length = 200)
