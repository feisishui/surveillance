...
import com.casic.patrol.api.humantask.ParticipantDTO;
...
import com.casic.patrol.bpm.support.DelegateTaskHolder;
import com.casic.patrol.bpm.support.HumanTaskBuilder;
...
public class HumanTaskTaskListener extends DefaultTaskListener {
    ...
    public void onCreate(DelegateTask delegateTask) throws Exception {
        ...
        if (humanTaskDto != null) {
            ...
            Set<TaskParticipant> participants = taskInfoManager.get(Long.parseLong(humanTaskDto.getId())).getTaskParticipants();
            if (participants != null && participants.size() > 0) {
                for (TaskParticipant temp : participants) {
                    delegateTask.addCandidateUser(temp.getRef());
                }
            }
        }
    }
