...
@SequenceGenerator(name = "CD_SEQ_BPM_PROCESS",sequenceName = "CD_SEQ_BPM_PROCESS",allocationSize = 1,initialValue = 1)
public class BpmProcess implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_PROCESS")
    public Long getId() {
        return this.id;
    }
