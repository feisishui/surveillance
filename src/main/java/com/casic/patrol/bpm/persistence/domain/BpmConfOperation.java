...
@SequenceGenerator(name = "CD_SEQ_BPM_CONF_OPERATION",sequenceName = "CD_SEQ_BPM_CONF_OPERATION",allocationSize = 1,initialValue = 1)
public class BpmConfOperation implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_CONF_OPERATION")
    public Long getId() {
        return this.id;
    }
