...
@SequenceGenerator(name = "CD_SEQ_BPM_CONF_NODE",sequenceName = "CD_SEQ_BPM_CONF_NODE",allocationSize = 1,initialValue = 1)
public class BpmConfNode implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_CONF_NODE")
