...
@SequenceGenerator(name = "CD_SEQ_BPM_CONF_LISTENER",sequenceName = "CD_SEQ_BPM_CONF_LISTENER",allocationSize = 1,initialValue = 1)
public class BpmConfListener implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_CONF_LISTENER")
