...
@SequenceGenerator(name = "CD_SEQ_BPM_CONF_FORM",sequenceName = "CD_SEQ_BPM_CONF_FORM",allocationSize = 1,initialValue = 1)
public class BpmConfForm implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_CONF_FORM")
