...
@SequenceGenerator(name = "CD_SEQ_BPM_MAIL_TEMPLATE",sequenceName = "CD_SEQ_BPM_MAIL_TEMPLATE",allocationSize = 1,initialValue = 1)
public class BpmMailTemplate implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_MAIL_TEMPLATE")
    public Long getId() {
        return this.id;
    }
