...
@SequenceGenerator(name = "CD_SEQ_BPM_CONF_USER",sequenceName = "CD_SEQ_BPM_CONF_USER",allocationSize = 1,initialValue = 1)
public class BpmConfUser implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_CONF_USER")
    public Long getId() {
        return this.id;
    }
