...
@SequenceGenerator(name = "CD_SEQ_BPM_CONF_NOTICE",sequenceName = "CD_SEQ_BPM_CONF_NOTICE",allocationSize = 1,initialValue = 1)
public class BpmConfNotice implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_CONF_NOTICE")
    public Long getId() {
        return this.id;
    }
