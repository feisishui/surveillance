...
@SequenceGenerator(name = "CD_SEQ_BPM_CONF_BASE",sequenceName = "CD_SEQ_BPM_CONF_BASE",allocationSize = 1,initialValue = 1)
public class BpmConfBase implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_CONF_BASE")
