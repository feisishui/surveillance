...
@SequenceGenerator(name = "CD_SEQ_BPM_INSTANCE",sequenceName = "CD_SEQ_BPM_INSTANCE",allocationSize = 1,initialValue = 1)
public class BpmInstance implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CD_SEQ_BPM_INSTANCE")
    public Long getId() {
        return this.id;
    }
